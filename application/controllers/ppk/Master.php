...
class Master extends CI_Controller {
	...
	public function kegiatan_data()
	{
		...
		$this->load->view('ppk/master/kegiatan_data',$data);
	...
	public function output_data()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('ppk/template/header',$data);
		$this->load->view('ppk/master/output_data',$data);
		$this->load->view('ppk/template/footer');
	}
	...
	public function sub_output_data()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('ppk/template/header',$data);
		$this->load->view('ppk/master/sub_output_data',$data);
		$this->load->view('ppk/template/footer');
	}
	...
	public function komponen_data()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('ppk/template/header',$data);
		$this->load->view('ppk/master/komponen_data',$data);
		$this->load->view('ppk/template/footer');
	}
	...
	public function sub_komponen_data()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('ppk/template/header',$data);
		$this->load->view('ppk/master/sub_komponen_data',$data);
		$this->load->view('ppk/template/footer');
	}
	...
	public function departemen_data()
	{
		...
		$data['grand_child'] = '';
		$this->load->view('ppk/template/header',$data);
		$this->load->view('ppk/master/departemen_data',$data);
		$this->load->view('ppk/template/footer');
	}
