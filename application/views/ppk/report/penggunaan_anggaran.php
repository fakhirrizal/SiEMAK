...
<script type="text/javascript">
	$(function(){
		$.ajaxSetup({
			type:"POST",
			url: "<?php echo site_url('/ppk/Report/ajax_function')?>",
			cache: false,
		});
		...
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					...
					<form role="form" class="form-horizontal" action="<?=base_url('ppk_side/penggunaan_anggaran');?>" method="post" enctype='multipart/form-data'>
						<div class="form-body">
					...
					<script type="text/javascript" language="javascript" >
						$(document).ready(function(){
							...
							$('#tbl').dataTable({
								...
								"ajax" : {
									type:"POST",
									url:"<?= site_url('ppk/Report/json_penggunaan_anggaran'); ?>",
