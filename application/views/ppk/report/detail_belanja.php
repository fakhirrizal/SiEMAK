...
<ul class="page-breadcrumb breadcrumb">
	...
	<li>
		<span><a href='<?= site_url('/ppk_side/penggunaan_anggaran'); ?>'>Data Belanja</a></span>
		<i class="fa fa-circle"></i>
	</li>
	<li>
			...
			<div class="portlet light ">
				<div class="portlet-body">
					<div class='row'>
						...
						<?php }} ?>
						<div class="col-md-12" >
						<hr><a href="<?php echo base_url()."ppk_side/penggunaan_anggaran"; ?>" class="btn btn-info" role="button"><i class="fa fa-angle-double-left"></i> Kembali</a></div>
					</div>
				</div>
			</div>
		</div>
