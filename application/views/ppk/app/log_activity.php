						...
						<div class="row">
							<div class="col-md-6">
								<div class="btn-group">
									...
									<a href="<?=base_url('ppk_side/cleaning_log');?>" class="btn red uppercase">Kosongkan Log <i class="fa fa-trash"></i> </a>
							</div>
						</div>
					</div>
								...
								<td>
									<div class="btn-group" style="text-align: center;">
										...
										<ul class="dropdown-menu" role="menu">
											...
											<li>
												<a onclick="return confirm('Anda yakin?')" href="<?=site_url('ppk_side/hapus_aktifitas/'.md5($value->activity_id));?>">
...
<script>
	$(document).ready(function(){
		$.ajaxSetup({
			type:"POST",
			url: "<?php echo site_url(); ?>ppk/App/ajax_function",
			cache: false,
		});
