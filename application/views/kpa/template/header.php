							...
							<li class="dropdown dropdown-user dropdown-dark">
								<a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
									...
									if($getdata->photo==NULL){
										$foto = 'https://www.pngitem.com/pimgs/m/78-786293_1240-x-1240-0-avatar-profile-icon-png.png';
									}else{
								...
								<ul class="dropdown-menu dropdown-menu-default">
									<li>
										<a href="<?php echo site_url('kpa_side/bantuan'); ?>">
					...
					<div class="hor-menu  ">
						<ul class="nav navbar-nav">
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='home'){echo 'active';}else{echo '';} ?>">
								<a href="<?php echo site_url('kpa_side/beranda'); ?>"><i class="icon-home"></i> Beranda
								</a>
							</li>
							...
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='laporan'){echo 'active';}else{echo '';} ?>">
								...
								<ul class="dropdown-menu pull-left">
									<li class=" <?php if($child=='penggunaan_anggaran'){echo 'active';}else{echo '';} ?>">
										<a href="<?php echo site_url('kpa_side/penggunaan_anggaran'); ?>" class="nav-link nav-toggle ">
											<i class="icon-pin"></i> Penggunaan Anggaran
										</a>
									</li>
									<li class=" <?php if($child=='pendapatan'){echo 'active';}else{echo '';} ?>">
										<a href="<?php echo site_url('kpa_side/pendapatan'); ?>" class="nav-link nav-toggle ">
							...
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='log_activity'){echo 'active';}else{echo '';} ?>">
								<a href="<?php echo site_url('kpa_side/log_activity'); ?>"><i class="fa fa-rss"></i> Log Aktifitas
								</a>
							</li>
							<li class="menu-dropdown classic-menu-dropdown <?php if($parent=='about'){echo 'active';}else{echo '';} ?>">
								<a href="<?php echo site_url('kpa_side/tentang_aplikasi'); ?>"><i class="icon-bulb"></i> Tentang Aplikasi
								</a>
							</li>
						</ul>
					</div>
