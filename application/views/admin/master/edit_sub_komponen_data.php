		...
		<div class="col-md-12">
			<div class="portlet light ">
				<div class="portlet-body">
					<form role="form" class="form-horizontal" action="<?=base_url('admin_side/perbarui_data_sub_komponen');?>" method="post" enctype='multipart/form-data'>
						<input type="hidden" name="<?=$this->security->get_csrf_token_name();?>" value="<?=$this->security->get_csrf_hash();?>">
						<input type="hidden" name="id" value='<?= md5($data_utama->id_sub_komponen); ?>'>
						<div class="form-body">
							<div class="form-group form-md-line-input has-danger">
								<label class="col-md-2 control-label" for="form_control_1">Kode Sub Komponen <span class="required"> * </span></label>
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="kode_sub_komponen" placeholder="Type something" value='<?= $data_utama->kode_sub_komponen; ?>' readonly>
                            ...
                            <div class="form-group form-md-line-input has-danger">
								<label class="col-md-2 control-label" for="form_control_1">Sub Komponen <span class="required"> * </span></label>
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="sub_komponen" placeholder="Type something" value='<?= $data_utama->sub_komponen; ?>' required>
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
										<i class="icon-pin"></i>
									</div>
								...
								<div class="col-md-10">
									<div class="input-icon">
										<select class="form-control" id='kode_sub_output' name="kode_sub_output" required>
                                            <?php
                                            $out = $this->Main_model->getSelectedData('tbl_sub_output a', 'a.*', array('a.kode_sub_output'=>$data_utama->kode_sub_output,'a.kode_output'=>$data_utama->kode_output,'a.kode_kegiatan'=>$data_utama->kode_kegiatan))->row();
                                            echo'<option value="'.$data_utama->kode_sub_output.'">'.$out->sub_output.'</option>';
                                            ?>
										</select>
										<div class="form-control-focus"> </div>
										<i class="icon-pin"></i>
                            ...
                            <div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<select class="form-control" id='kode_komponen' name="kode_komponen" required>
                                            <?php
                                            $out = $this->Main_model->getSelectedData('tbl_komponen a', 'a.*', array('a.kode_komponen'=>$data_utama->kode_komponen,'a.kode_sub_output'=>$data_utama->kode_sub_output,'a.kode_output'=>$data_utama->kode_output,'a.kode_kegiatan'=>$data_utama->kode_kegiatan))->row();
                                            echo'<option value="'.$data_utama->kode_komponen.'">'.$out->komponen.'</option>';
                                            ?>
										</select>
										<div class="form-control-focus"> </div>
										<i class="icon-pin"></i>
