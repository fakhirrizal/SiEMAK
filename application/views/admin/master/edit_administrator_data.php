					...
					<form role="form" class="form-horizontal" action="<?=base_url('admin_side/perbarui_data_admin');?>" method="post" enctype='multipart/form-data'>
						...
						<div class="form-body">
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="nama" placeholder="Type something" value='<?= $data_utama->fullname; ?>' required>
							...
							<div class="form-group form-md-line-input has-danger">
								...
								<div class="col-md-10">
									<div class="input-icon">
										<input type="text" class="form-control" name="un" placeholder="Type something" value='<?= $data_utama->username; ?>' readonly>
										<div class="form-control-focus"> </div>
										<span class="help-block">Some help goes here...</span>
